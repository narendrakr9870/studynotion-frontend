...
export const courseEndpoints = {
  ...
  CREATE_SECTION_API: "http://localhost:4000/api/v1/course/createSection",
  CREATE_SUBSECTION_API: "http://localhost:4000/api/v1/course/createSubSection",
  ...
  DELETE_SUBSECTION_API: "/http://localhost:4000/api/v1course/deleteSubSection",
